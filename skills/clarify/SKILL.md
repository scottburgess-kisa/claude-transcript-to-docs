...
## Instructions
This skill receives the selected documents list and runs in two rounds of questions.
...
After the user answers Round 1, ask questions ONLY for the selected documents.
...
#### If SLACK UPDATE is selected, ask:
...
#### If SUCCESS STORY is selected, ask:
